...
def parse_args():
    ...
    p.add_argument('--known_width', type=float, default=0.05,
                   help='Known object width in meters (for distance estimation)')
    return p.parse_args()
...
def main():
    ...
    try:
        while True:
            ...
            results = model(frame, imgsz=640, conf=0.2, iou=0.45)
